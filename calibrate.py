...
# 
# THIS IS FOR CALCULATING THE DISTORTION OF THE LENS
...
# prepare empty object points, like (0,0,0), (1,0,0), (2,0,0) ....,(6,5,0)
...
for fname in images:
    ...
    if ret == True:
        ...
        cv2.imshow('img',img)
        # write the image to the checks folder with markers on it
...
# place all the calculated points in the cv calibrate function
